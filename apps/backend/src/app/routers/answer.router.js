...
router.get('/id/:id', answerValidation.checkId, answerController.getOne);
router.get('/commentId/:commentId', answerValidation.getAllAnswerComment, answerController.getAllAnswerOfComment);
