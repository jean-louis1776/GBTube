...
import { NOT_DIGIT, NOT_EXISTS, NOT_INT, REG_EXP_FOR_DIGITS } from "../util/validationMessages";
...
export class AnswerValidation extends Validation {
  ...
  constructor() {
    ...
    this.getAllAnswerComment = [ param('commentId').exists().withMessage(NOT_EXISTS).matches(REG_EXP_FOR_DIGITS).withMessage(NOT_DIGIT) ];
  }
}
